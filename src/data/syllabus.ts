...
export const jeeAdvanced: JungleData = {
  ...
  chapters: [
    ...
    // Chemistry (labeled as Chemistry, not Ch• CH)
    createChapter('ja-chem-1', 'Chemistry: Advanced Thermodynamics', 'chemistry'),
    createChapter('ja-chem-2', 'Chemistry: Chemical Kinetics (Graph)', 'chemistry'),
    createChapter('ja-chem-3', 'Chemistry: Electrochemistry', 'chemistry'),
    createChapter('ja-chem-4', 'Chemistry: Solutions', 'chemistry'),
    createChapter('ja-chem-5', 'Chemistry: States of Matter', 'chemistry'),
    createChapter('ja-chem-6', 'Chemistry: Functional Groups', 'chemistry'),
    createChapter('ja-chem-7', 'Chemistry: Hydrocarbons', 'chemistry'),
    createChapter('ja-chem-8', 'Chemistry: Biomolecules & Polymers', 'chemistry'),
    createChapter('ja-chem-9', 'Chemistry: Reaction Mechanisms', 'chemistry'),
    createChapter('ja-chem-10', 'Chemistry: Coordination (CFT + MOT)', 'chemistry'),
    createChapter('ja-chem-11', 'Chemistry: Stereochemistry', 'chemistry'),
    createChapter('ja-chem-12', 'Chemistry: Qualitative Analysis', 'chemistry'),
    // Mathematics
